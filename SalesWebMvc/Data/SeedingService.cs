...
{
    public class SeedingService //Classe que serve para povoar o banco de dados com dados
    {
        ...
        public void Seed() //Procedimento que povoa o banco de dados efetivamente
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) //A operação Any do Linq verifica se já existe algum registro em uma tabela do database
            {
                return; //Corta a execução do método se o DB já está populado
            }
